...
### Requirements
The only requirement is NumPy for building the nodes in `gen_nodes.py` and usage by passing in NumPy arrays. The `demo/tests/*` scripts use a couple other dependencies, but it is not necessary for the package. 
